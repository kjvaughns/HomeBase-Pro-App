...
const styles = StyleSheet.create({
  ...
  subheadline: { ...Typography.subhead, lineHeight: 22 },
  ...
  helperText: { ...Typography.caption2, marginTop: Spacing.xs },
  divider: {
  ...
  legalText: { ...Typography.caption2, textAlign: "center", lineHeight: 16 },
});
