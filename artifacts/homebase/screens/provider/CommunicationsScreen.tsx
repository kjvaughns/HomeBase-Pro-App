    ...
    <ThemedView style={styles.container}>
              ...
              >
                {selectedClient ? (
                  <View style={styles.selectedClientRow}>
                    <Avatar
                      uri={selectedClient.avatarUrl ?? undefined}
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    <Avatar uri={item.avatarUrl ?? undefined} name={name} size="small" />
                    <View style={{ flex: 1, marginLeft: Spacing.md }}>
      ...
      >
        <View style={[styles.confirmOverlay, { paddingHorizontal: horizontalPadding }]}>
          <View style={[styles.confirmDialog, { backgroundColor: theme.backgroundRoot }]}>
