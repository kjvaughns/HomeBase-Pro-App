            ...
            <div style={{ padding: 8 }}>
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: "1px solid var(--border)" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ height: 12, width: "55%", borderRadius: 4, background: "var(--surface-2)", marginBottom: 6 }} />
        ...
        <div style={styles.panel}>
          ...
          {isLoading ? (
            <div style={{ padding: 8 }}>
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: "1px solid var(--border)" }}>
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "var(--surface-2)", flexShrink: 0 }} />
                  <div style={{ flex: 1 }}>
                    <div style={{ height: 12, width: "60%", borderRadius: 4, background: "var(--surface-2)", marginBottom: 6 }} />
                    <div style={{ height: 10, width: "40%", borderRadius: 4, background: "var(--surface-2)" }} />
                  </div>
                </div>
              ))}
            </div>
